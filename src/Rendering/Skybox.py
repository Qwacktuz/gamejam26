...
class Skybox:
    ...
    def render(self, camera: Camera):
        ...
        pos = (int(camera.pos[0] * self.skyboxSpeed)-300) // image.get_width() * image.get_width() + (int(camera.pos[0] * self.skyboxSpeed)-300) % image.get_width()
        ...
        pos = (int(camera.pos[0] * self.skyboxSpeed)) // image.get_width() * image.get_width() + (int(camera.pos[0] * self.skyboxSpeed)) % image.get_width()
